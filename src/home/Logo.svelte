...
<a href="/" aria-label="gibr.net home">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" aria-hidden="true">
    <g fill="currentColor">
      ...
      <path
        d="M72,38V34H50.63a13.56,13.56,0,0,1,3.76,4H44a6,6,0,0,0,0,12c.22,0,.43,0,.64,0l.17,0a3.54,3.54,0,0,0,.45-.08l.17,0a3.6,3.6,0,0,0,.44-.12l.14-.05c.15-.06.3-.11.44-.18l.11,0,.45-.23.07,0a3.52,3.52,0,0,0,.45-.3l0,0a4,4,0,0,0,.45-.37h0c.14-.14.29-.28.42-.43h0a5.53,5.53,0,0,0,.72-1H44V41H55.62A11.35,11.35,0,0,1,56,44V79.5A7.18,7.18,0,0,1,54.5,84,7.06,7.06,0,0,1,56,88.5,7.41,7.41,0,0,1,53.6,94H72V50h9V38Z"
      />
      <path d="M120,96a8,8,0,0,1,0,16h-6V96Z" />
      <path
        d="M96,74H93.6A7.46,7.46,0,0,1,96,79.28,7.15,7.15,0,0,1,94.5,83.5,7.06,7.06,0,0,1,96,88h0v32a8,8,0,0,0,16,0V74Z"
      />
      <path
        d="M50,56V54.39A11.51,11.51,0,0,1,44,56H8A8,8,0,0,0,8,72H48.5A7.41,7.41,0,0,1,54,74.4V56H50Z"
      />
    </g>
  </svg>
</a>
